...
<div id="whole_page">
    ...
    <div id="option">
        ...
        <a href="EntityListServlet?class=entity.Teacher" class="btn" style="background-color: gray;float:left;margin-left: 15px;text-decoration:none">EntityList</a>
    </div>
    ...
    <div id="content" >
        <table id="table">
            ...
            <%}%>
                ...
                <td class="cell">
                    <a href="TeacherCheckServlet?id=<%=teachers.get(i).getId()%>" style="color:red">查看</a>
                    <a href="TeacherEditServlet?id=<%=teachers.get(i).getId()%>" style="color:red">修改</a>
                </td>
            </tr>
            <%} %>
            </tbody>
